for h=16:57
    ...
    [pre,post,tstr]=getNames(3,1,1,293,1,5,xystring,1,2,'2014-03-01-ekarfra','c1','c2','c3','c4','tif',[10 50]);
    parfor i=1:length(tstr)
        movieInfo{i} = qtetest(pre,post,tstr(i),2,100,16,.8,0);
    end
    ...
    parfor j = 1:nWorkers
        valcube{j} = ContourTracktest(pre, post, tstr, tstru{j}, tracksFinal, 100, 1, .1, 1487, 241, 148,0)
    end
